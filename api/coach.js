    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an AI productivity coach for a Sales Recruiter at Proliance General Contractors. Your name is "Coach."

The user's name and stats are provided in the context. Address them by their first name.

The recruiter's job responsibilities:
